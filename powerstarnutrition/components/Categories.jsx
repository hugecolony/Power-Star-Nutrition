  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 md:gap-6 xl:gap-8">
      <a href="#" className="group relative flex h-48 items-end justify-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-96">
        <Image src={ISOWHEY} loading="lazy" alt="ISOWHEY" classNameName="absolute inset-0  object-cover transition duration-200 group-hover:scale-110"  width={250}/>
      ...
      <a href="#" className="group relative flex h-48 items-end justify-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-96">
        <Image src={GOLDMASS} loading="lazy" alt="GOLDMASS" classNameName="absolute inset-0   object-center transition duration-200 group-hover:scale-110"  width={250} />
      ...
      <a href="#" className="group relative flex h-48 items-end justify-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-96">
      <Image src={PREWORKOUT} loading="lazy" alt="Photo by Lorenzo Herrera" classNameName="absolute inset-0 object-fit transition duration-200 group-hover:scale-110" width={250}  />
      ...
      <a href="#" className="group relative flex h-48 items-end justify-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-96">
      <Image src={BCAA} loading="lazy" alt="Photo by Lorenzo Herrera" classNameName="absolute inset-0 object-fit transition duration-200 group-hover:scale-110" width={250}  />
